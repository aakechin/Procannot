...
For installation of blastn v. 2.2.30 download it from http://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/2.2.30 and copy blastn file from bin/ directory to the $PATH directory, e.g. /usr/local/bin/
